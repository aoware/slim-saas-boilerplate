CREATE TABLE `web_session_log` (
  ...
  `session_token` char(32) NOT NULL COMMENT 'Session used by the user during this http call',
  `user_id` int(11) NOT NULL COMMENT 'the user_id logged to perform the particular action',
  ...
  `payload` text DEFAULT NULL COMMENT 'payload content',
